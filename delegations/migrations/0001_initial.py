    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'new'), ('valid', 'valid'), ('ended', 'ended'), ('paidoff', 'paidoff')], default='new', max_length=255)),
                ('base_currency', models.CharField(choices=[('euro', 'euro'), ('zloty', 'zloty'), ('yen', 'yen'), ('british pound', 'british pound'), ('juan', 'juan'), ('swiss franc', 'swiss franc'), ('czech koruna', 'czech koruna'), ('american dollar', 'american dollar')], default='zloty', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmation', models.FileField(blank=True, null=True, upload_to='uploads/expense/% Y/% m/% d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(choices=[('euro', 'euro'), ('zloty', 'zloty'), ('yen', 'yen'), ('british pound', 'british pound'), ('juan', 'juan'), ('swiss franc', 'swiss franc'), ('czech koruna', 'czech koruna'), ('american dollar', 'american dollar')], default='zloty', max_length=255)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(('return_date__gt', django.db.models.expressions.F('departure_date'))), name='check_start_date'),
        ),
    ]
